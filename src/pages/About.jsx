            ...
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <div className="text-center mb-16">
                    ...
                    <p className="text-base-content/70 mt-3 text-sm sm:text-base max-w-2xl mx-auto">
                        We believe that a clean community is a shared responsibility. Find out how CleanTrack empowers every citizen.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="order-1 lg:order-2">
                        ...
                        <p className="mb-8 text-base-content/80 leading-relaxed">
                            CleanTrack was founded on the idea that local issues often go unresolved due to a lack of proper communication channels. We provide a simple, transparent portal for citizens to instantly report issues like illegal dumping, road damage, and broken public property.
                        </p>
                        ...
                        <div className="space-y-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-semibold text-lg text-base-content">Transparent Tracking</h4>
                                    <p className="text-sm text-base-content/70">Track the status of every reported issue, from 'Ongoing' to 'Resolved'.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-semibold text-lg text-base-content">Community Funding</h4>
                                    <p className="text-sm text-base-content/70">Contribute financially to help fund immediate cleanup and repair operations.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-semibold text-lg text-base-content">Action & Volunteering</h4>
                                    <p className="text-sm text-base-content/70">Join local cleanup drives and turn reported issues into community action.</p>
                                </div>
                            </div>
                        </div>
